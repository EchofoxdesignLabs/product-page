    ...
    function init()
    {
        ...
        loader.load(
            'assets/models/bakedfinal20.glb',
            (gltf) => {
                ...
                { name: "Brand", targetOffset: new THREE.Vector3(-1, 0, 2), cameraPosition: new THREE.Vector3(600, 10, -60), category: "Utility", title: "Brand", description: "Built for the top performing DJs, Promoters, Venues, Festivals and Artists.", link: "#" },
